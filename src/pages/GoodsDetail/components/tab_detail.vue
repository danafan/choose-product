<template>
	<div>
		<div class="detail_info">
			<div class="info_box">
				<div class="flex">
					<div class="detail_label">浏览量：</div>
					<div>{{goods_info.views_num}}次</div>
				</div>
				<div class="flex">
					<div class="detail_label">30天销量：</div>
					<div>{{goods_info.sales_num_all}}件</div>
				</div>
			</div>
			<div class="info_box">
				<div class="flex">
					<div class="detail_label">选中量：</div>
					<div>{{goods_info.select_num}}</div>
				</div>
				<div class="flex">
					<div class="detail_label">市场：</div>
					<div>{{goods_info.market_name}}</div>
				</div>
			</div>
			<div class="info_box">
				<div class="flex">
					<div class="detail_label">提供拍照：</div>
					<div>{{goods_info.supply_photograph}}</div>
				</div>
				<div>&nbsp</div>
			</div>
		</div>
