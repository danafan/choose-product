	...
	<div class="setting_content">
		<el-card class="card_box" id="card_box">
			...
			<el-table size="mini" :data="data.data" tooltip-effect="dark" style="width: 100%" :header-cell-style="{'background':'#f4f4f4','text-align': 'center'}" :cell-style="{'text-align':'center'}" :max-height="max_height" v-loading="loading">
				...
				<el-table-column label="季节" prop="season_name" show-overflow-tooltip></el-table-column>
				...
				<el-table-column label="操作" width="180" fixed="right">
					<template slot-scope="scope">
						...
						<el-button type="text" size="small" @click="deleteFn(scope.row.season_id)" v-if="data.button_list.del == 1">删除</el-button>
					</template>
				</el-table-column>
			</el-table>
			...
			<div class="dialog_content">
				<el-form size="small" label-width="120px">
					<el-form-item label="季节：" required>
						<el-input type="textarea" autosize placeholder="请输入季节（多个请换行）" v-model="name">
						</el-input>
					</el-form-item>
				</el-form>
			</div>
