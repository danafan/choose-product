<template>
	<div class="goods_item">
		<div class="image_box">
			...
			<img class="goods_image" src="../static/user_img.png" slot="reference"/>
		</el-popover>
	...
	<el-dialog :show-close="false" :visible.sync="show_select">
				...
				<div class="banner">
					<el-carousel indicator-position="none" arrow="never" @change="changeImage" ref="cardShow">
						<el-carousel-item v-for="item in banner_list" :key="item">
							<el-image class="image" :src="item" fit="contain" :preview-src-list="banner_list"></el-image>
						</el-carousel-item>
					</el-carousel>
